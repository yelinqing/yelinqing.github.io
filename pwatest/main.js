...
var API_KEY = window.GoogleSamples.Config.APPLICATION_KEYS.privateKey;
...
function subscribe() {
  ...
  var pushButton = document.querySelector('.js-push-button');
  pushButton.disabled = true;
  const applicationServerKey = urlB64ToUint8Array(window.GoogleSamples.Config.APPLICATION_KEYS.publicKey);
